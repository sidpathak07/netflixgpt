...
const MainContainer = () =>{
    ...
    console.log(movies);
    return(
        <div className="relative w-full h-screen text-white pb-40">
            {
                movies.length>0 && (
                    <>
                        <VideoBackground movieId={movies[0]?.id} />
                        <div className="absolute inset-0 flex items-center justify-start px-10 bg-gradient-to-b to-grey-900">
