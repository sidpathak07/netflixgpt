...
const Header = () => {
    ...
    return (
        <header className="text-white bg-black bg-gradient-to-b from-gray-700 p-4 flex justify-between">
            <img className="w-44 h-10   to-transparent" src="/Netflix_Logo_PMS.png" alt="Netflix Logo" />
